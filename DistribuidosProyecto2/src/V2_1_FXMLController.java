...
public class V2_1_FXMLController implements Initializable {
    ...
    public void inicioSesion(MouseEvent evento) throws IOException, SQLException{         
        ...
        Servicentro.setNombre(this.usuario.getText());
        Servicentro.iniciarListener();      
        iniciarSesion();  
        /*
    ...
    private void iniciarSesion() throws IOException{            
            ...
            URL location = V2_1_FXMLController.class.getResource("V2_FXML.fxml");
            loader.setLocation(location);
            Stage stage = new Stage();
            stage.setTitle(" Shell | Panel de Control");
